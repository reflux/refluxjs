...
This project uses [eventemitter3](https://github.com/3rd-Eden/EventEmitter3), which is currently MIT licensed and [has it's license information here](https://github.com/3rd-Eden/EventEmitter3/blob/master/LICENSE).